...
class LongMember(private val default: Long) : Member() {

	private val current = ThreadLocal.withInitial { Long2LongArrayMap() }

	operator fun getValue(ref: Strukt, prop: KProperty<*>) = current.get()[ref.strukt.pointer]

	operator fun setValue(ref: Strukt, prop: KProperty<*>, value: Long) {
