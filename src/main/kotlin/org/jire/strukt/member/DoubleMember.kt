...
class DoubleMember(private val default: Double) : Member() {

	private val current = ThreadLocal.withInitial { Long2DoubleArrayMap() }

	operator fun getValue(ref: Strukt, prop: KProperty<*>) = current.get()[ref.strukt.pointer]

	operator fun setValue(ref: Strukt, prop: KProperty<*>, value: Double) {
