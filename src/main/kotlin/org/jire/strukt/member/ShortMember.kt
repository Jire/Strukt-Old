...
class ShortMember(private val default: Short) : Member() {

	private val current = ThreadLocal.withInitial { Long2ShortArrayMap() }

	operator fun getValue(ref: Strukt, prop: KProperty<*>) = current.get()[ref.strukt.pointer]

	operator fun setValue(ref: Strukt, prop: KProperty<*>, value: Short) {
