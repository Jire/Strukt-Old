...
class BooleanMember(private val default: Boolean) : Member() {

	private val current = ThreadLocal.withInitial { Long2BooleanArrayMap() }

	operator fun getValue(ref: Strukt, prop: KProperty<*>) = current.get()[ref.strukt.pointer]

	operator fun setValue(ref: Strukt, prop: KProperty<*>, value: Boolean) {
