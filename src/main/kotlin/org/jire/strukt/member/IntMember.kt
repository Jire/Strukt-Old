...
class IntMember(private val default: Int) : Member() {

	private val current = ThreadLocal.withInitial { Long2IntArrayMap() }

	operator fun getValue(ref: Strukt, prop: KProperty<*>) = current.get()[ref.strukt.pointer]

	operator fun setValue(ref: Strukt, prop: KProperty<*>, value: Int) {
