...
class ByteMember(private val default: Byte) : Member() {

	private val current = ThreadLocal.withInitial { Long2ByteArrayMap() }

	operator fun getValue(ref: Strukt, prop: KProperty<*>) = current.get()[ref.strukt.pointer]

	operator fun setValue(ref: Strukt, prop: KProperty<*>, value: Byte) {
