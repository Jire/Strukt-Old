...
class CharMember(private val default: Char) : Member() {

	private val current = ThreadLocal.withInitial { Long2CharArrayMap() }

	operator fun getValue(ref: Strukt, prop: KProperty<*>) = current.get()[ref.strukt.pointer]

	operator fun setValue(ref: Strukt, prop: KProperty<*>, value: Char) {
